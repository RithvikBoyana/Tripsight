                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            HStack {
                                Image(systemName: "heart.circle.fill")
                                    .font(.title)
                                    .foregroundColor(.blue)
                                TextField("Add interest then press enter", text: $viewModel.currentInterest)
                                    .textFieldStyle(CustomTextFieldStyle(backgroundColor: textFieldBackgroundColor))
                                    .font(.body)
                                    .frame(height: 50)
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            HStack {
                                Image(systemName: "calendar.circle.fill")
                                    .font(.title)
                                    .foregroundColor(.blue)
                                TextField("Enter Duration (1-20 days)", value: $viewModel.days, formatter: NumberFormatter())
                                    .textFieldStyle(CustomTextFieldStyle(backgroundColor: textFieldBackgroundColor))
                                    .font(.body)
